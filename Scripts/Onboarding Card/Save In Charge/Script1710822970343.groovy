...
WebUI.findWebElement(findTestObject('Object Repository/01_Maker/02_Onboarding Card/Dashboard/span_cl_mkr_2'), 2)

WebUI.scrollToElement(findTestObject('Object Repository/01_Maker/02_Onboarding Card/Dashboard/span_cl_mkr_2'), 2)
