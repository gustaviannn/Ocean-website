...
public class stepdef_maker {
	...
	def getAplRegNum() {
		return WebUI.getAttribute(findTestObject('Object Repository/Maker/Onboarding Client/addClient/apl_number'), 'title')
	}
	...
	def fill_applicationData(String application_id) {
		...
		WebUI.setText(findTestObject('Object Repository/Maker/Onboarding Client/addClient/input_applicationID'), apl_reg_num)
