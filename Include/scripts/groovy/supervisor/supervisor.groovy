...
class supervisor {
	...
	def spvApprove() {
		...
		WebUI.takeScreenshot()
		WebUI.waitForElementPresent(findTestObject('Object Repository/Dashboard/Application Proses New Contract/span_Accept'), 0)
		WebUI.takeScreenshot()
		WebUI.click(findTestObject('Object Repository/Dashboard/Application Proses New Contract/span_Accept'))
		WebUI.takeScreenshot()
		WebUI.waitForElementPresent(findTestObject('Object Repository/Dashboard/Application Proses New Contract/button_Save'), 0)
		WebUI.takeScreenshot()
		WebUI.click(findTestObject('Object Repository/Dashboard/Application Proses New Contract/button_Save'))
